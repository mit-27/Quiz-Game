...
{
    system("color 7e");
	fstream f1("File.txt",ios::in | ios::out | ios::app);
...
main()
{
    ...
    if(  cin.get())
    {
        ...
        gotoxy(68,30);
        cout<<"3. SCORECARD AND EXIT FROM THE QUIZ";
    ...
    else
    {
        ...
        gotoxy(70,50);
        cout<<"OK,GOOD BYE !!!";
        system("cls"); gotoxy(70,50);cout<<" $$$ CREATED BY MIT AND UMANG $$$#";exit(1);
    }
    gotoxy(68,34);
